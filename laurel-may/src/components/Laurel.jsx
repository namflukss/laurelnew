...
const STARTERS = [
  'Build my festival plan — 12-min drama, just finished editing',
  'Feature doc, 87 min — what are my Sundance odds?',
  "Experimental animation, 7 min, no dialogue. What's my best shot?",
]
    ...
    <div className={styles.root}>
      ...
      <div className={styles.inputArea}>
        <div className={styles.inputWrap}>
          ...
          >
            <span className={styles.sendBtnSlash}>//</span> SEND →
          </button>
        </div>
